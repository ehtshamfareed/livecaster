<?php
if($_POST['search']){$search_keyword = $_POST['search'];}else{header("Location: ../index.php");}
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7 col-lg-12">
                    ...
                    <div class="row">
                        <?php
                        $getsnewsbykeywords = News::search_by_title_description($conn,$search_keyword);
                        while ($getnewsresult = $getsnewsbykeywords->fetch_assoc()) {
                        ?>
                            <!-- Single Post -->
